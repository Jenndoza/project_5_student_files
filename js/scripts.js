...
//Function used to parse through data
...
//Function to help check status of the url
...
/**
 * Creates interactions with the previous, next, and close buttons on modal.
 * @param {array} data - array of objects with information about people
...
function modalBtns(data, index) {
    ...
    //Event listener on button to close modal and return to gallery
...
//Event listener updates page when submit button is clicked
